...
class Parameters{
	private:
		...
		std::string optionRewardPath;   //path to the file containing the reward information
	   ...
	   /**
		...
		/**
 		* @param std::string name path to the file that will store the option reward structure
 		*   along the game. This parameter is optional.
 		*/
		void setOptionRewardPath(std::string name);
		/**
	...
	public:
		...
		/**
 		* @return std::string path to the file that will store the option reward structure
 		*   along the game. This parameter is optional.
 		*/
		std::string getOptionRewardPath();
		/**
