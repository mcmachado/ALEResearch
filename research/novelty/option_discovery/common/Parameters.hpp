...
class Parameters{
	...
	public:
		...
		float optionTerminationProb;      //probability an options is going to terminate in the next timestep
		...
		int learningLength;               //The number of frames to be learned, in total (for each eigenbehaviour)
		...
		int numNewEigenBehavioursPerIter; //number of eigenbehaviour to be learned at each new iteration
