...
class SarsaLearner : public RLLearner{
	private:
        ...
        */
        void loadWeights();
        void saveCheckPoint(int episode, int totalNumberFrames,  std::vector<float>& episodeResults,
			int& frequency, std::vector<int>& episodeFrames, std::vector<double>& episodeFps);
